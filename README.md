...
HydraPop can validate a property graph against a [GraphSchema](https://central.sonatype.com/artifact/net.fortytwo.hydra/hydra-java) using Hydra's built-in support for
[property graph validation](https://github.com/CategoricalData/hydra/tree/main/demos/validatepg).
...
2. Validate with `hydra.validate.pg.validate_graph`
