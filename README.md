...
Most of the logic in this repository is demonstrated in "Java mode" and also in "Python mode", in parallel.
...
Hydra also supports other languages; we have chosen Java and Python because they are especially common for working
with TinkerPop.
